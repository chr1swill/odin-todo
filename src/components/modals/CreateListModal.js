...
export function ListModalComponet() {
    ...
    createBtn.innerHTML = DefaultButtonComponent("Create List", "submit", "sumbit");
    ...
    return (
        `<dialog close class="bg-primary rounded-md p-5 max-w-[calc(100vw-2rem)] backdrop:bg-text/50">
            <form method="dialog">
